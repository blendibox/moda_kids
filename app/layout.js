...
export default function RootLayout({ children }) {
  return (
    <html lang="pt-BR">
		<head>
		   <meta charSet="UTF-8" />
		   <link rel="alternate" type="application/rss+xml" href="https://modakids.blendibox.com.br/googleMerchant_1.xml" />
		   ...
		   <script
			  ...
			  dangerouslySetInnerHTML={{
				__html: JSON.stringify({
				  ...
				  "@type": "WebSite",
				  "url": "https://modakids.blendibox.com.br/",
				  "potentialAction": {
					"@type": "SearchAction",
					"target": "https://modakids.blendibox.com.br/busca?{search_term_string}",
